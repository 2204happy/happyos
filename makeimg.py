...
if len(sys.argv) < 3:
  ...
  fs = bytearray([0]*(3072))
  initfsstr = b"\x02\x01\x00\xff\xff\x00\x00\x01boot.sys\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x02\x00\xff\xff\x01\x00\x03kernel.sys\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x03\x00\xff\xff\x04\x00\x06fs.sys\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\xff\xff\x00\x00\x00\x00\x00sys\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
  ...
  sysfiles = [[root+"/sys/boot.sys",0],[root+"/sys/kernel.sys",512],[root+"/sys/fs.sys",2048]]
